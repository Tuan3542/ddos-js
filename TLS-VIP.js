...
const targetPort = parsedTarget.protocol === 'https:' ? 443 : 80;
    ...
    console.clear();
console.log('TLS-HTTPS : Tuan3542'.rainbow);
console.log(`Target : ${parsedTarget.host} | Port : ${targetPort}`.rainbow);
console.log(`Time : ${args.time.toString()} Second`.rainbow);
console.log(`Threads : ${args.threads.toString()}`.rainbow);
console.log(`Rate : ${args.Rate.toString()}`.rainbow);
console.log(`Proxy : ${args.proxyFile} | ${proxies.length}`.rainbow);
console.log(`User : Tuan3542 | Expiry : 99/99/9999`.rainbow);
